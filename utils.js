...
exports.from_hex = exports.to_hex = exports.swap_byte = exports.h_distance = exports.byte_diff = exports.pairbit_diff = exports.mod_diff = exports.l_capturing = exports.topval = exports.bit_pairs_diff_table = void 0;
const _1 = require(".");
exports.bit_pairs_diff_table = [
    Uint8Array.from([
...
exports.topval = Uint32Array.from([
    1,
    2,
    3,
    5,
...
function l_capturing(len) {
    ...
    while (true) {
        ...
        if ((len <= exports.topval[idx]) && (len > exports.topval[idx - 1])) {
            return idx;
        }
        if (len < exports.topval[idx]) {
            top = idx - 1;
        }
        else {
            bottom = idx + 1;
...
exports.l_capturing = l_capturing;
...
function pairbit_diff(pairb, opairb) {
    ...
    if (diff == 0) {
        ...
        return _1.hist_diff1_add;
    }
    else if (diff == 2) {
        return _1.hist_diff2_add;
    }
    return _1.hist_diff3_add;
}
...
function h_distance(len, x, y, tlsh_distance_parameter = false) {
    let diff = 0;
    if (tlsh_distance_parameter) {
        for (let i = 0; i < len; i++) {
            let dist2 = byte_diff(x[i], y[i]);
            if ((_1.hist_diff1_add == 1) && (_1.hist_diff2_add == 2) && (_1.hist_diff3_add == 6)) {
                let dist1 = exports.bit_pairs_diff_table[x[i]][y[i]];
                if (dist1 != dist2) {
    ...
    for (let i = 0; i < len; i++) {
        diff += exports.bit_pairs_diff_table[x[i]][y[i]];
    }
    return diff;
}
exports.h_distance = h_distance;
function swap_byte(input) {
    let byte = 0;
    byte = ((input & 0xF0) >> 4) & 0x0F;
    byte |= ((input & 0x0F) << 4) & 0xF0;
    return byte;
}
exports.swap_byte = swap_byte;
/** Port from tlsh js file. */
function to_hex(src, len) {
    let s = "";
    for (let i = 0; i < len; i++) {
        if (src[i] < 16) {
            s = s.concat("0");
